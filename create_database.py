...
def create_script(cmsswpath,samplesname,rootfile):
    ...
    script+='python '+cmsswpath+'src/MEMDataBase/MEMDataBase/test/createDataBaseFromTree_spring17.py '+OutputDirectoryForMEMDatabase+samplename+' '+samplename.replace("_","").replace("-","")+' '+rootfile
